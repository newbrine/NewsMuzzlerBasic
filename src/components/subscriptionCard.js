...
import { Box, Heading, Icon, Menu, MenuButton, MenuList, MenuItem, Text, Badge, Modal, ModalOverlay, ModalContent, 
    ModalFooter, ModalHeader, ModalBody, ModalCloseButton, Button, useDisclosure, Grid, Collapse, ThemeProvider } from "@chakra-ui/core";
...
export default function SubscriptionCard(props){
    ...
    return(
        ...
        <ThemeProvider>
            <Box bg="white" alignContent="right" w="95%">
