...
export default function LeftMenu () {
    ...
    const [selectedComponent, dispatch1] = useReducer(reducer, initialState);
    return (
                ...
                <ThemeProvider>
                    ...
                    <Box
                        ...
                        <Stack spacing={0}>
                            ...
                            <Button onClick={() => dispatch1({ type: 'dashboard' })} _hover={{background: "#534488", stroke: "#534488" }} backgroundColor="#2B2737" className={"leftMenu-btnTxt"} height="90px">
